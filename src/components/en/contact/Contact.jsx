                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <a href="mailto:examplemail@gmail.com.com" className="contact__button">{contactEn.button2}{""}
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=62214408789&text=Hello, more information!" className="contact__button">{contactEn.button2}{""}
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://m.me/crypticalcoder" className="contact__button">{contactEn.button2}{""}
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
